...
public class CollectionWorkRequest extends WorkRequest {
    ...
    public String getRaisedByDairy() {
        return raisedByDairy;
    }

    public void setRaisedByDairy(String raisedByDairy) {
        this.raisedByDairy = raisedByDairy;
    }
